...
@stopit_after_timeout(60, raise_exception=True)
def get_ellipticty(args):
    ...
    img_g1 = noise + img_g1
    geometry = EllipseGeometry(x0=128, y0=128, sma=5, eps=0.2,
...
if __name__ == "__main__":
    #for testing
#     args = ['/hildafs/home/diptajym/hildafs2/10-701/depth/pics/images/150.jpg','150']
#     result = get_ellipticty(args)
#     print(result)
    images = glob.glob("/hildafs/home/diptajym/hildafs2/10-701/depth/pics/images/*.jpg")
    args = []
    for img in images:
    ...
    with multiprocessing.Pool() as pool:
        ...
        while True:
            try:
                ...
                if(results[0]>0):
                    processed_ids.append(int(results[1]))
    ...
    f = open("processed_ellipticity",'w')
